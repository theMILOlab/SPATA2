...
To initiate a `SPATA2` object directly from the Visium output use the function `initiateSpataObjectVisium()`. It works for both slide types, those with a capture area of 6.5mm x 6.5mm (referred to as `VisiumSmall` in SPATA2) and of 11mm x 11mm (referred to as `VisiumLarge` in SPATA2). This example vignette uses data from a 6.5mm x 6.5mm. You can download the folder [here](https://drive.google.com/drive/folders/15K58GOAhxHrehpS-OQ7qAGKNzns5VaKE?usp=sharing). 
